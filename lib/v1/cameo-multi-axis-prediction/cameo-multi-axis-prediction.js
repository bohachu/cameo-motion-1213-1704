...
class CameoMultiAxisPrediction extends HTMLElement {
  ...
  async chart_render() {
    ...
    columnSeries.columns.template.tooltipText =
      "[font-size: 12px]產值[/] [font-size: 12px]{valueY}[/]";
    ...
    column2Series.columns.template.tooltipText =
      "[font-size: 12px]預測產值[/] [font-size: 12px]{valueY}[/]";
    ...
    bullet.tooltipText =
      "[font-size: 12px]年增率[/] [font-size: 12px]{valueY}%[/]";
    ...
    bullet.fill = am4core.color(dic_meta["線圖顏色"]);
    bullet.tooltipText =
      "[font-size: 12px]預測年增率[/] [font-size: 12px]{valueY}%[/]";
    var circle = bullet.createChild(am4core.Circle);
    circle.radius = 4;
